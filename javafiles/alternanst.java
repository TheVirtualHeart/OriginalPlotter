...
/*      <applet code="alternanst" width=650 height=750>
         </applet>
*/

	public class alternanst extends Applet
...
//                                                                        }
        ...
        gBuffer.setColor(Color.orange);
          ...
          gBuffer.drawLine(ip1,iyp,ip2,iyp);
                     }
         ...
         gBuffer.setColor(Color.green);
          ...
          int ip4=(int)(2*p4+50);
          int iyp=(int)(275-.25*120);
          gBuffer.drawLine(ip3,iyp,ip4,iyp);
                     }
