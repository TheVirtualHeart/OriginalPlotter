...
/*
         <applet code="fourv0dN" width=450 height=350>
         </applet>
 */

public class fourv0dN extends Applet 
...
//		Choice options= new Choice();  moved up  NEW ADDED
	...
	public void paint(Graphics g) {
		...
		if(firsttime){
			...
			if(itype==4){                    //NEW ADDED

                twp= Double.valueOf(Tbutton5a.getText()).intValue();
