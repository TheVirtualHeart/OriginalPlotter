...
// new for Drew to keep adding  NEW ADDED see below 
                 ...
                 twp= Double.valueOf(Tbutton5a.getText()).intValue(); // if doesnt work put .doubleValue());
                 if(twp==200 || twp==280){customcell=0; }
                 else{ customcell=1;}
