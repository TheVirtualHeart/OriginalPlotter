...
/*      <applet code="alternansbiphasicCV" width=950 height=650>
         </applet>
*/

	public class alternansbiphasicCV extends Applet
...
///-----------------------------------
        ...
        for(int i=0; i<nvt-1; i++){
             ...
             vv=vlo+dvt*(double)(i);
           table1[i]= (1+ ((Math.exp(xk*(vv-ucsi))-Math.exp(-xk*(vv-ucsi)))/
                           (Math.exp(xk*(vv-ucsi))+Math.exp(-xk*(vv-ucsi)))) )/(2.*tsi) ;
...
//         gBuffer.fillRect(50,340,nx*2,500);
         gBuffer.fillRect(50,250,mx,180);
         gBuffer.fillRect(50,440,mx,80);
         gBuffer.fillRect(50,530,mx,100);
        ...
        if(nntime==0 && nchplot==1) gBuffer.fillRect(380,58,502+50,357+50);
         gBuffer.fillRect(380,58,160,57);

 
        gBuffer.fillRect(50,58,mx,187);
        gBuffer.setColor(Color.blue);

        gBuffer.drawRect(50,58,mx,187);
        gBuffer.setColor(Color.black);
...
//        gBuffer.drawString("--40",50+nx,695);
        gBuffer.drawString("--50",50+mx,417);
        gBuffer.drawString("60--",20,405);
        gBuffer.drawString("--70",50+mx,392);
        gBuffer.drawString("80--",20,380);
        gBuffer.drawString("--90",50+mx,367);
//        gBuffer.drawString("100--",15,355);
        gBuffer.drawString("--110",50+mx,342);
//        gBuffer.drawString("120--",15,330);
        gBuffer.drawString("--130",50+mx,317);
        gBuffer.drawString("140--",15,305);
        gBuffer.drawString("--150",50+mx,292);
        gBuffer.drawString("160--",15,280);
        gBuffer.drawString("--170",50+mx,267);
        gBuffer.drawString("APD",15,259);

         if(imm==4){
        gBuffer.drawString("--153",50+mx,458);
        gBuffer.drawString("--150",50+mx,482);
        gBuffer.drawString("--147",50+mx,506);
                   }

         if(imm==1){
        gBuffer.drawString("--295",50+mx,458);
        gBuffer.drawString("--297",50+mx,482);
        gBuffer.drawString("--299",50+mx,506);
                   }

        if(imm==2){
        gBuffer.drawString("--223",50+mx,458);
        gBuffer.drawString("--225",50+mx,482);
        gBuffer.drawString("--227",50+mx,506);
                   }

        if(imm==3){
        gBuffer.drawString("--163",50+mx,458);
        gBuffer.drawString("--165",50+mx,482);
        gBuffer.drawString("--167",50+mx,506);
                   }

        if(imm==5){
        gBuffer.drawString("--133",50+mx,458);
        gBuffer.drawString("--135",50+mx,482);
        gBuffer.drawString("--147",50+mx,506);
                   }
        ...
        gBuffer.drawString("--46",50+mx,550);
        gBuffer.drawString("--45",50+mx,562);
        gBuffer.drawString("--44",50+mx,574);
        gBuffer.drawString("--43",50+mx,586);
        ...
        gBuffer.fillRect(383,98,25,2);  
              ...
              gBuffer.setColor(Color.black);
     if(nchplot==1){   gBuffer.drawString("Time (ms)                >",455,437+50);
...
//        gBuffer.drawString("cm/s",1,569);
     ...
     if(nchplot==1){
        ...
        gBuffer.fillRect(578,430+50,100,2);  
                    }
...
//        gBuffer.drawString("APD",57+mx,320);
//        gBuffer.drawString("(ms)",57+mx,330);


//        gBuffer.drawString("--30",50+2*mx,720);
        gBuffer.setColor(Color.white);
        gBuffer.fillRect(55,414,mx-8,15);
    
           for(int i=25; i< nx-1; i++){
           ...
           gBuffer.fillRect(50+i-25,415,1,13);                            
           if(ii==97)gBuffer.fillRect(50+i-25,415,3,13); 
                                       }
...
//          int ip2=(int)(2*p2+50);
          ...
          gBuffer.drawLine(i+50-25,iyp,i+51-25,iyp);
                     }
...
//         gBuffer.drawLine(2*i+20,nyy1,2*i+20,nyy2);
          ...
          gBuffer.setColor(Color.black);               //Plotting Voltage vs X in time first window 
         int yy1=(int)(225-u[i]*120.0);
         int yy2=(int)(225-u[i+1]*120.0);
         gBuffer.drawLine(3*i/3+50-25,yy1,3*i/3+51-25,yy2);

        if(i>5 && lapd1[i+1] > 10){
        gBuffer.setColor(Color.orange);
         int yyy1=(int)((480-lapd1[i]*1.25));
         int yyy2=(int)((480-lapd1[i+1]*1.25));
         gBuffer.drawLine(i+50-25,yyy1,i+51-25,yyy2);
 ...
 //         gBuffer.setColor(Color.blue);
         if(i > 4 && i< nx-4 )gBuffer.drawLine(3*i/3+50-27,500+yyy1/5,3*i/3+51-27,500+yyy2/5);
//	  gBuffer.setColor(Color.orange);
          ...
          if(yyy2 > 440 && yyy1 > 440 && yyy2 < 520 && yyy1 < 520 )gBuffer.drawLine(i+50-25,yyy1,i+51-25,yyy2);
        ...
        gBuffer.setColor(Color.green);
         ...
         gBuffer.drawLine(i+50-25,yyx1,i+51-25,yyx2);
        ...
        if(yyx2 > 440 && yyx1 > 440 && yyx2 < 520 && yyx1 < 520 ) gBuffer.drawLine(i+50-25,yyx1,i+51-25,yyx2);
                   
          yyx1=nncv2[i];
          yyx2=nncv2[i+1];
 //       if(i > 11 && i< nx-6 && yyx2 > 530) gBuffer.drawLine(i+50,yyx1,i+51,yyx2);
       if(i > 4 && i< nx-4 ) gBuffer.drawLine(3*i/3+50-27,500+yyx1/5,3*i/3+51-27,500+yyx2/5);
       ...
       // Draw restitution 
         ...
         double x=0.0;
           ...
           if(nchplot==1) nntime=nntime+1;
             if(nntime > 120000 ) nntime=0;    // time for plotting in time
        if(nntime==0 && nchplot==1) {
            gBuffer.setColor(Color.white);
            gBuffer.fillRect(380,68,502+150,350+50);
            gBuffer.setColor(Color.black); }
...
//                     }
           ...
           if(u[j] > uv) xq=1;
                 ...
                 dv=(1-xp)*(1-v[j])/((1-xq)*tvm+tvmm*xq)-xp*v[j]/tvp ;
		 if(xp == 0.0 && u[j] <= 0.04) dv=(0.25-v[j])/40. ;
		 if(xp == 0.0 && u[j] <= 0.01) dv=(1-v[j])/90.   ;

                 dw=(1-xp)*(1-w[j])/twm-xp*w[j]/twp ;

           v[j] = v[j] + dt*dv ;
           w[j] = w[j] + dt*dw ;
    
           xfi = -v[j]*xp*(u[j]-uc)*(um-u[j])/td ;
           xso = (u[j]-uo)*(1-xp)/to + xp/tr ;
           xsi = -w[j]*table1[ivindex];
//           xsi = -w[j]*(1+ ((Math.exp(xk*(u[j]-ucsi))-Math.exp(-xk*(u[j]-ucsi)))/
//                           (Math.exp(xk*(u[j]-ucsi))+Math.exp(-xk*(u[j]-ucsi)))) )/(2.*tsi) ;
//             xsi=-1./(2.*tsi);
//           xsi = -w[j]*(1 + 
...
///////////////////////////////////////////////////////////////////////
        ...
        if(nflag[j] >2)gBuffer.setColor(Color.green);
         ...
         int vy1=(int)(u[j]*30);
         int vy2=(int)(ut[j]*30);
         int xntime1=(int)(nntime/200);       // 200 is the scaling for plotting x
         int xntime2=(int)((nntime+1)/200);
