...
//*******************************************************************************
      ...
      //import java.awt.image.ColorModel;
        import java.awt.image.IndexColorModel;
         ...
         /*
         <applet code="tdfhn" width=420 height=400>
          </applet>
          */
...
//  for wheat use (rgb=245 222 179)
    ...
    setBackground(background);
        ...
        lvent= getImage(getCodeBase(), "java1.gif");
...
add (ls1size);
add (txts1size);
txts1size.reshape (270,175,35,25);
ls1size.reshape (265,202,65,25);
...
*/
      ...
      txtgsize.setText(String.valueOf(gsize));
           ...
           Panela.setLayout(new GridLayout(8,2));
           Panela.add(ldt);
           Panela.add(txtdt);
           Panela.add(ldx);
           Panela.add(txtdx);
...
//      g.drawString(" "+gsize+"  "+iipy+" "+iipy+"",245,50);
//    if(g1 == null)
//     g1 = img1.getGraphics();
 //    plot.setColor(background);
//     plot.fillRect(0,0,201,201);
if(nfirst==0){
          g.setColor(Color.black);
          g.fillRect(2,270,355,130);
          g.setColor(Color.white);
          g.drawLine(10,382,10,300);
          g.drawLine(10,382,350,382);
...
if(nstop==0){
 ...
 /*         if(nbsignal==1){
   ...
   */
          ...
          uipx=(float)u[ipx+norig][ipy+norig];
          g.drawString("u("+ipx+","+ipy+")="+uipx,10,282);
//          g.drawString(" "+gsize+"  "+iipx+" "+iipx+"",50,320);
//          g.drawString(" "+gsize+"  "+iipy+" "+iipy+"",50,340);
          ny1=(int)(385-(usig[1]+.4)*60);
          nx1=10;
          for(int ik=2; ik<nxsignal; ik++){
          ny2=(int)(385-(usig[ik]+.4)*60);
          nx2=(int)(10+ik);
         ...
         if(nchvsig==1 && nbsignal ==1 ){
          ...
          vipx=(float)v[ipx+norig][ipy+norig];
          g.drawString("v("+ipx+","+ipy+")="+vipx,10,296);
          ny1=(int)(365-(vsig[1])*250);
          nx1=10;
          for(int ik=2; ik<nxsignal; ik++){
          ny2=(int)(365-(vsig[ik])*250);
          nx2=10+ik;
          g.drawLine(nx1,ny1,nx2,ny2);
          ny1=ny2;
          nx1=nx2;
        ...
        g.fillRect(240,65,70,20);
        g.fillRect(240,245,70,20);
        g.setColor(Color.black);


       if(mplot==1){
           g.drawString("Volt_max",245,75);
           g.drawString("Volt_min",245,255);
                        } 
           else{
        ...
        //      mapon=0;           
         if(nbstim==0 && nbsignal==1){
//         jpx=(int)(p.x-10-norig);
//         jpy=(int)(p.y-60-norig);
         g.setColor(Color.white);
 //        g.fillRect(ipx-2+norig,ipy-2+norig,3,3);
            g.fillRect(ipx+9+norig,ipy+59+norig,3,3);
                                     }
    ...
    int jj=(int)(j/2);        
      ...
      int  kk=(int)(130.*(u[i][j]+.4));
        if(kk > 80){
         ...
         pix[jj*100+ii]= (byte)(kk);
           g.setColor(new Color(ir[kk],ig[kk],ib[kk]));
           g.fillRect(i,j,2,2);                            
...
//        if(nmap==0){
//          img = createImage(new MemoryImageSource(100, 100,
//                        myColorModel, pix, 0, 100));
//                    }
//        if(nmap==1){
//          img = createImage(new MemoryImageSource(100, 100,
//                        myColorModel2, pix, 0, 100));
//                    }   
//        if(nmap==2){
//          img = createImage(new MemoryImageSource(100, 100,
//                        myColorModel3, pix, 0, 100));
//                    }         
//     g.drawImage(lvent,0,0, this);
//            g.setColor(Color.black); 
//            g.drawLine(10,10,50,50);

//     g.drawImage(img,10,60,200,200, this); 
          mmtime=0;
              }
     //   g1.drawImage(img1,10,10, this);
// } ///here
mmtime=mmtime+1;
