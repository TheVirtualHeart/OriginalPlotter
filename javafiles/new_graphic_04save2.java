	...
	public void paint(Graphics g) {
			...
			//Color table
			{
				if (nmap == 0) {
					for (int ii = 0; ii < maplength; ii += 2){
						...
						g.fillRect(dsx + 2*ss + 10, dsy + ss - ii/2 + 1, 10, 2);
					}
                        	         	for (int i = 0; i < ss; i++) {
			                	for (int j = 0; j < ss; j++) {
                                                 ...
                                                 if(iii <30) iii=30;
						g.setColor(new Color(ir[iii], ig[iii], ib[iii]));
						g.fillRect(dsx+i*2 , dsy+j*2 , 2, 2);
                                                                               }
                                                                               }
				...
				if (nmap == 1) {
					for (int ii = 0; ii < maplength; ii += 2){
						...
						g.fillRect(dsx + 2*ss + 10, dsy + ss - ii/2 + 1, 10, 1);
					}
                                		for (int i = 0; i < ss; i++) {
			                	for (int j = 0; j < ss; j++) {
                                                 int iii=(int)(190*u[i][j][time]/norma);
						g.setColor(new Color(irr[iii], igg[iii], ibb[iii]));
						g.fillRect(dsx+i*2 , dsy+j*2 , 2, 2);
                                                                               }
                                                                               }
				...
				if (nmap == 2) {
					for (int ii = 0; ii < maplength; ii += 2){
						...
						g.fillRect(dsx + 2*ss + 10, dsy + ss - ii/2 + 1, 10, 1);
			                	...
			                	for (int j = 0; j < ss; j++) {
                                                 int iii=(int)(190*u[i][j][time]/norma);
						g.setColor(new Color(irrr[iii], iggg[iii], ibbb[iii]));
						g.fillRect(dsx+i*2 , dsy+j*2 , 2, 2);
                                                                               }
                                                                               }
				...
				g.setColor(Color.black);
				g.drawString(" V max", dsx + 2*ss + 22, dsy + ss - maplength/2 + 10);
				g.drawString(" V min", dsx + 2*ss + 22, dsy + ss - 2);
			}
		...
		//	g.fillRect(dsx, dsy, ss + 4, ss + 4);
			...
			*/
			...
			g.setColor(Color.black);
			g.drawString(" time=", dsx + 2*ss + 42, dsy + ss - maplength/2 + 30);
			g.drawString(String.valueOf(time), dsx + 2*ss + 102, dsy + ss - maplength/2 + 30);
