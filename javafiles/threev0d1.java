	...
	import java.awt.event.*;
        ...
        /*
         <applet code="threev0d1" width=500 height=800>
         </applet>
          */

	public class threev0d1 extends Applet 
...
//-----------add on parameters and boxes------------------

   private Panel parameterPanel;
   private Label Gfi, Tr, Tsi, To, Tv, Tv1, Tv2, TwP, TwM, Uc, Uv, UcSi, Td, Xk;
   private TextField TextGfi, TextTr, TextTsi, TextTo, TextTv, TextTv1, TextTv2, TextTwP, TextTwM;
   private TextField TextUc, TextUv, TextUcSi, TextTd, TextXk;
...
//=================================================================
	...
	butt = new Button ("Start");
       ...
       // ************************************************adding new panel + text labels
       parameterPanel = new Panel();
       
       Gfi = new Label(" Gfi ");
   	   TextGfi = new TextField(3);
   	   TextGfi.addActionListener( this);
   	   TextGfi.setText("4.0");

   	   
   	   Tr = new Label(" Tr ");
   	   TextTr = new TextField(3);
   	   TextTr.addActionListener(this);
   	   TextTr.setText("33.33");

   	   
   	   Tsi = new Label(" Tsi ");
	   TextTsi = new TextField(3);
	   TextTsi.addActionListener( this);
	   TextTsi.setText("29.0");

	   
	   To = new Label(" To ");
   	   TextTo = new TextField(3);
   	   TextTo.addActionListener( this);
   	   TextTo.setText("29.0");

   	   
   	   Tv = new Label(" Tv ");
	   TextTv = new TextField(3);
	   TextTv.addActionListener( this);
	   TextTv.setText("3.33");

	   
	   Tv1 = new Label(" Tv1 ");
   	   TextTv1 = new TextField(3);
   	   TextTv1.addActionListener( this);
   	   TextTv1.setText("1250.0");

   	   
       Tv2 = new Label(" Tv2 ");
	   TextTv2 = new TextField(3);
	   TextTv2.addActionListener( this);
	   TextTv2.setText("19.6");

	   
	   TwP = new Label(" TwP ");
   	   TextTwP = new TextField(3);
   	   TextTwP.addActionListener( this);
   	   TextTwP.setText("870.0");

   	   
   	   TwM = new Label(" TwM ");
	   TextTwM = new TextField(3);
	   TextTwM.addActionListener( this);
	   TextTwM.setText("41.0");

	   
	   Uc = new Label(" Uc ");
   	   TextUc = new TextField(3);
   	   TextUc.addActionListener( this);
   	   TextUc.setText("0.13");

   	   
       Uv = new Label(" Uv ");
	   TextUv = new TextField(3);
	   TextUv.addActionListener( this);
	   TextUv.setText("0.04");

	   
	   UcSi = new Label(" UcSi ");
   	   TextUcSi = new TextField(3);
   	   TextUcSi.addActionListener( this);
   	   TextUcSi.setText("0.85");
   	   
   	   Td = new Label(" Td ");
	   TextTd = new TextField(3);
	   TextTd.addActionListener( this);
	   TextTd.setText("0.25");
       ...
       Xk = new Label(" Xk ");
       TextXk = new TextField(3);
       TextXk.addActionListener(this);
       TextXk.setText("10.0");
   	   
   	   parameterPanel.setLayout(new GridLayout(3,4));
   	   
   	   parameterPanel.add(Td);
   	   parameterPanel.add(TextTd);
   	   
   	   parameterPanel.add(Xk);
	   parameterPanel.add(TextXk);
   	   
   	   parameterPanel.add(Gfi);
       parameterPanel.add(TextGfi);
   	   
   	   parameterPanel.add(Tr);
   	   parameterPanel.add(TextTr);
   	   
	   parameterPanel.add(Tsi);
   	   parameterPanel.add(TextTsi);
   	   
   	   parameterPanel.add(To);
	   parameterPanel.add(TextTo);
   	    	   
	   parameterPanel.add(Tv);
   	   parameterPanel.add(TextTv);
   	   
   	   parameterPanel.add(Tv1);
	   parameterPanel.add(TextTv1);
   	   
	   parameterPanel.add(Tv2);
   	   parameterPanel.add(TextTv2);
   	   
   	   parameterPanel.add(TwP);
	   parameterPanel.add(TextTwP);
   	   
	   parameterPanel.add(TwM);
   	   parameterPanel.add(TextTwM);
   	   
   	   parameterPanel.add(Uc);
	   parameterPanel.add(TextUc);
   	   
	   parameterPanel.add(Uv);
   	   parameterPanel.add(TextUv);
   	   
       parameterPanel.add(UcSi);
	   parameterPanel.add(TextUcSi);
...
//        xtso=  1.3151681e+000;
      ...
      if(itype==2){
        ...
        TextTv.setText("3.33");
        tvm1=1000.0;
        TextTv1.setText("1000.0");
        tvm2=19.2;
        TextTv2.setText("19.2");
        twp=667.0;
        TextTwP.setText("667.0");
        twm=11.0;
        TextTwM.setText("11.0");
        td=0.25;
        TextTd.setText("0.25");
        to=8.3;
        TextTo.setText("8.3");
      ...
      if(itype==3){
       ...
       TextTv.setText("10.0");
       tvm1=18.2; 
       TextTv1.setText("18.2");
       tvm2=18.2;
       TextTv2.setText("18.2");
       twp=1020.0; 
       TextTwP.setText("1020.0");
       twm=80.0;
       TextTwM.setText("80.0");
       td=0.172;
       TextTd.setText("0.172");
       to=12.5;
       TextTo.setText("12.5");
       tr=130;
       TextTr.setText("130.0");
       tsi=127;
       TextTsi.setText("127.0");
       xk=10.0;
       TextXk.setText("10.0");
       ucsi=0.85;
       TextUcSi.setText("0.85");
      ...
      // *********** adding itype 4 ********************
      if (itype == 4) {
    	  twp = Double.valueOf(TextTwP.getText()).doubleValue();
    	  tvp = Double.valueOf(TextTv.getText()).doubleValue();
    	  tvm1 = Double.valueOf(TextTv1.getText()).doubleValue();
    	  tvm2 = Double.valueOf(TextTv2.getText()).doubleValue();
    	  twm = Double.valueOf(TextTwM.getText()).doubleValue();
    	  td = Double.valueOf(TextTd.getText()).doubleValue();
    	  to = Double.valueOf(TextTo.getText()).doubleValue();
    	  tr = Double.valueOf(TextTr.getText()).doubleValue();
    	  tsi = Double.valueOf(TextTsi.getText()).doubleValue();
    	  xk = Double.valueOf(TextXk.getText()).doubleValue();
    	  ucsi = Double.valueOf(TextUcSi.getText()).doubleValue();
    	  uc = Double.valueOf(TextUc.getText()).doubleValue();
    	  uv = Double.valueOf(TextUv.getText()).doubleValue();
    	  tsi = Double.valueOf(TextTsi.getText()).doubleValue();
      }
...
//         else{sens =0;}
         ...
         itype=3;
          ...
          if(ae.getItem().toString()== optionopen){   // new add *************************
              itype=4;
               repaint();
                                                       }
