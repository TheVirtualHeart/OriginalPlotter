...
/*      <applet code="controlt01" width=650 height=630>
         </applet>
*/

	public class controlt01 extends Applet
...
//        Label label;
	...
	double lapd1old[] = new double[300];
	double lapd2old[] = new double[300];
	double lapd1new[] = new double[300];
	double lapd2new[] = new double[300];
	 ...
	 int controlpoint=25;
	 double apddif[] = new double[210];
	 int ncontrolpoint[] = new int[210];
...
//                                                                        }
         if(gama > 0 ) gBuffer.drawLine(2*controlpoint+20,69,2*controlpoint+20,78);
...
//                            deltat=gama*(lapdn-lapdold)/dt;
			     ...
			     lapd1old[j]=lapd1new[j];
			     lapd1new[j]=lapd1[j];
		            deltat=gama*(lapd1new[j]-lapd1old[j])/dt;
