...
class JavaCode {
    ...
    static {
        // Call up the static library libmycodeinc.so created 
        // from ccode.c
//System.setProperty("java.library.path", "C:\\fenton\\CD\\jdk1.6.0_19\\bin");
//        System.loadLibrary("mycodeinc");
       System.load("C:/fenton/CD/jdk1.6.0_19/bin/libmycodeinc.so");
    }
}
