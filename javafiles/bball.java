...
/*      <applet code="bball" width=400 height=400>
         </applet>
*/
public class bball extends Applet implements Runnable {
  ...
  public void init() {
    ...
    ball = getImage(getCodeBase(), "bball.gif" );
...
//    bufferGraphics.fillOval(x-r, y-r, r*2, r*2);            // draw the circle
      bufferGraphics.drawImage(ball,x-(int)(xscale/2),y-(int)(yscale/2),xscale,yscale,this);
