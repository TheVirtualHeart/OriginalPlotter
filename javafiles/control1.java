...
/*      <applet code="control1" width=450 height=600>
         </applet>
*/

	public class control1 extends Applet
...
//
	public void update(Graphics g){ paint(g); }  
        ...
        public void paint(Graphics g){
          ...
          gBuffer.fillRect(0,0,500,320);
         gBuffer.setColor(Color.black);
         gBuffer.fillRect(20,330,380,300);
        ...
        gBuffer.drawString("L= ("+String.valueOf(nx)+") points",100,300);
         ...
         gBuffer.drawString("Control",225,220);
...
//         g.drawString(String.valueOf(mmm),200,280);
       ...
       // Draw restitution 
         ...
         double x=0.0;
           ...
           if(u[j] > -72.0)xpp=1.0;
           if(u[j] > -79.5)xqq=1.0;
           h[j]=h[j]+dt*((1.0-xpp)*(1-h[j])/(1000.0*xqq+9.2*(1-xqq))-0.3*xpp*h[j]);
