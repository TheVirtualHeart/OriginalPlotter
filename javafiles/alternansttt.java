...
/*      <applet code="alternansttt" width=1300 height=750>
         </applet>
*/

	public class alternansttt extends Applet
...
//
	public void update(Graphics g){ paint(g); }  
        ...
        if(nntime==0) gBuffer.fillRect(650,68,660,650);
...
//        gBuffer.drawString("T= T_o *gama*(APD_n+1-APD_n)",130,320);
        ...
        gBuffer.drawString("--40",50+2*nx,695);
        gBuffer.drawString("--50",50+2*nx,670);
        gBuffer.drawString("--60",50+2*nx,645);
        gBuffer.drawString("--70",50+2*nx,620);
        gBuffer.drawString("--80",50+2*nx,595);
        gBuffer.drawString("--90",50+2*nx,570);
        gBuffer.drawString("--100",50+2*nx,545);
        gBuffer.drawString("--110",50+2*nx,520);
        gBuffer.drawString("--120",50+2*nx,495);
        gBuffer.drawString("--130",50+2*nx,470);
        gBuffer.drawString("--140",50+2*nx,445);
        gBuffer.drawString("--150",50+2*nx,420);
        gBuffer.drawString("--160",50+2*nx,395);
        gBuffer.drawString("--170",50+2*nx,370);
        gBuffer.drawString("--180",50+2*nx,345);
        gBuffer.drawString("APD",57+2*nx,320);
        gBuffer.drawString("(ms)",57+2*nx,330);
...
//         g.drawString(String.valueOf(mmm),200,280);
       ...
       // Draw restitution 
        ...
        if(nntime==0) {
            gBuffer.setColor(Color.white);
            gBuffer.fillRect(650,68,660,650);
            gBuffer.setColor(Color.black); }
...
///////////////////////////////////////////////////////////////////////
        ...
        if(nflag[j] >2)gBuffer.setColor(Color.green);
         ...
         int xntime2=(int)((nntime+1)/35);
          ...
          gBuffer.drawLine(650+xntime1,130+j*1-vy1,xntime2+651,130+j*1-vy2);  
          ncounter=0;
                        }
