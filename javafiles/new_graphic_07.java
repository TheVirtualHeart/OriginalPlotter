...
public 	class 	new_graphic_07
	...
	private Point		p;
        ...
        //Comands for text files
        String optionFiles="Files to save:";
...
//	Color	background		= new Color(192,192,192);
	...
	public static void main(String args[]) {
		...
		new_graphic_07 a = new new_graphic_07();
	...
	public void paint(Graphics g) {
		...
		if (startmovie == false) {
			...
			if (frame11) {
				...
				/*
				if (originc) {
					umovie = originalimg;// -> original;
					//norma = (short)(Math.abs(origmax - origmin));
