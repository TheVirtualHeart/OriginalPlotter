...
public 	class 		new_graphic_01_up
		extends		Frame 
	...
	public static void main(String args[]) {
		...
		//Create an instance of new_graphic_01_up 
		new_graphic_01_up a = new new_graphic_01_up();
	...
	public void itemStateChanged(ItemEvent ie ){
		...
		//APD - DI distribution
		if (apdDiDist.getState() == true) 	apdDistc = true;
		else 								apdDistc = false;
		
		if (apdDiMeanS.getState() == true) 	apdDiMeanc = true;
		else 								apdDiMeanc = false;
