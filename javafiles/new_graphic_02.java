...
public 	class 		new_graphic_01
	...
	private Choice 		cnorm, colormap, clDuration;
	...
	public new_graphic_01() {
		...
		//INTERFACE
		{
			...
			apdDiMean	= new Button("Mean Rest.");
			...
			apdDiDist	= new Checkbox("APD-DI Distr.", false);
			...
			//APD distribution analysis conditions
			...
			//Elements Position***
			{
				...
				rowW.setLayout(new GridLayout(15,1));
				
				/*
				Panel rowW0 = new Panel();	//Title
				rowW0.setLayout(new FlowLayout(FlowLayout.LEFT));
				rowW0.add	(new Label("COMMANDS"));
				rowW.add	(rowW0);
				*/
				
				Panel rowW1 = new Panel();	//Start
				rowW1.setLayout(new FlowLayout(FlowLayout.LEFT));
				rowW1.add	( start );
				rowW.add	( rowW1);
				
				Panel rowW11 = new Panel();	//Stop
				rowW11.setLayout(new FlowLayout(FlowLayout.LEFT));
				rowW11.add	( stop );
				rowW.add	( rowW11);
				
				Panel rowW2 = new Panel();	//Reset
				rowW2.setLayout(new FlowLayout(FlowLayout.LEFT));
				rowW2.add	( reset );
				rowW.add	( rowW2 );
				
				Panel rowW22 = new Panel();	//Play movie
				rowW22.setLayout(new FlowLayout(FlowLayout.LEFT));
				rowW22.add	( movie );
				rowW.add	( rowW22 );
				
				Panel rowW3 = new Panel();	
				rowW3.setLayout(new FlowLayout(FlowLayout.LEFT));
				rowW3.add	( apdDiDist );
				rowW.add	( rowW3 );
				
				Panel rowW4 = new Panel();	//Alternance
				rowW4.setLayout(new FlowLayout(FlowLayout.LEFT));
				rowW4.add	( alternance );
				rowW.add	( rowW4 );
				
				Panel rowW5 = new Panel();	//Mean APD - DI
				rowW5.setLayout(new FlowLayout(FlowLayout.LEFT));
				//rowW5.add	( new Label("Mean Rest: ") );
				rowW5.add	( apdDiMean );
				rowW.add	( rowW5 );
				...
				rowE1.add	( new Label("ANALYSIS CONDITIONS") );
				rowE.add	( rowE1 );
				...
				rowE401.add	( new Label("APD - DI Thr:\t"));
				rowE401.add ( thr );
				rowE401.add	( signal8 );
				rowE401.add	( thrset );
				rowE.add	( rowE401 );
				
				Panel rowE99 = new Panel();	//Performe space average and evaluate thresholds
				...
				rowE42.add	( new Label("SIGNAL PLOT CONDITIONS") );
				rowE.add	( rowE42 );
				...
				Panel rowE80 = new Panel();				
				rowE80.add	( new Label("MOVIE & REST. CONDITIONS"));
				rowE.add	( rowE80 );
				
				Panel rowE82 = new Panel();		//Color maps
				...
				Panel rowE83 = new Panel();		//Color maps
				rowE83.setLayout(new FlowLayout(FlowLayout.LEFT));
				rowE83.add	( new Label("Max CL: "));
				rowE83.add	( clDuration );
				rowE.add	( rowE83 );
	...
	public void paint(Graphics g){
		...
		//Graph plot
		if (startmovie == false && apdDistc == false) {
			...
			g.drawString("Time (ms)", dpx + pw/2, ph + dpy - day/3);
			...
			if (firsttime) {
				...
				ayp2	= dpy + phm - day;	//y axes point 2
				ayp3	= dpy + phm - day;	//y axes point 3
				...
				g.drawString("Time (ms)", pw + 12, phm + dpy - day/2 + 6);
				g.drawString("V (mV)", dpx + dax/2 - 5, dpy + day/2 + 2);
			...
			*/
			...
			for (int i = 0; i < ss; i++) {
				for (int j = 0; j < ss; j++) {
					...
					//for (time = 10; time < (ntimes - 10); time++) {
		...
		if (originc) {
			...
			//if (startmovie == false) {
				...
				g.drawString(Integer.toString(origmin), dpx + dax/2, dpy + phG - day);
				g.drawString(Integer.toString(origmax), dpx + dax/3 - 3, dpy + day - 2);
			...
			//else {
			/*
				g.drawString(Integer.toString(origmin), dpx + da/2, dpy + phm - da);
				g.drawString(Integer.toString(origmax), dpx + da/3 - 3, dpy + da - 2);
		...
		if (unwrapc) {
			...
			g.drawString("UnwS", pw/3 + dax + 2, dpy + 20);
			...
			//if (startmovie == false) {
				...
				g.drawString(Integer.toString(unwmin), dpx + dax/2, dpy + phG - day);
				g.drawString(Integer.toString(unwmax), dpx + dax/3 - 3, dpy + day - 2);
			...
			/*}
				...
				g.drawString(Integer.toString(unwmin), dpx + da/2, dpy + phm - da);
				g.drawString(Integer.toString(unwmax), dpx + da/3 - 3, dpy + da - 2);
				...
				for (int t = 10; t < (ntimes - 10); t++) {
					...
					ayp2	= dpy + phm - 1*da;	//y axes point 2
					ayp3	= dpy + phm - 1*da;	//y axes point 3
		...
		if (tavec) {
			...
			g.drawString("TASi", pw/3 + 2*dax + 4, dpy + 20);
			//oldText = note.getText();
			g.drawString(Integer.toString(10), dpx + dax, dpy + phG - day/2);
			g.drawString(Integer.toString(ntimes-10), dpx + pw - dax - dax/2, dpy + phG - day/2);
			...
			//if (startmovie == false) {
				...
				g.drawString(Integer.toString(tavnmin), dpx + dax/2, dpy + phG - day);
				g.drawString(Integer.toString(tavnmax), dpx + dax/3 - 3, dpy + day - 2);
			...
			/*}
				...
				g.drawString(Integer.toString(tavnmin), dpx + da/2, dpy + phm - da);
				g.drawString(Integer.toString(tavnmax), dpx + da/3 - 3, dpy + da - 2);
				...
				for (int t = 10; t < (ntimes - 10); t++) {
					...
					ayp2	= dpy + phm - 1*da;	//y axes point 2
					ayp3	= dpy + phm - 1*da;	//y axes point 3
					kk1 	= (phm - 2*da)*(taveraged[nii][njj][t] 	   - tavnmin)/(tavnmax - tavnmin);
					kk2 	= (phm - 2*da)*(taveraged[nii][njj][t + 1] - tavnmin)/(tavnmax - tavnmin);
		...
		if (shiftl) {
			...
			g.setColor(Color.yellow);
			g.drawString("ShLn", pw/3 + 3*dax + 6, dpy + 20);
			...
			/*}
				...
				for (int t = 10; t < ntimes - 10; t++) {
					...
					ayp2	= dpy + phm - da;	//y axes point 2
					ayp3	= dpy + phm - da;	//y axes point 3
		...
		if (shiftc) {
			...
			g.drawString("ShSi", pw/3 + 4*dax + 8, dpy + 20);
			g.drawString(Integer.toString(10), dpx + dax, dpy + phG - day/2);
			g.drawString(Integer.toString(ntimes-10), dpx + pw - dax - dax/2, dpy + phG - day/2);
			
			//if (startmovie == false) {
				
				g.drawString(Integer.toString(shifmin), dpx + dax/2, dpy + phG - day);
				g.drawString(Integer.toString(shifmax), dpx + dax/3 - 3, dpy + day - 2);
			...
			/*}
				...
				g.drawString(Integer.toString(shifmin), dpx + da/2, dpy + phm - da);
				g.drawString(Integer.toString(shifmax), dpx + da/3 - 3, dpy + da - 2);
		...
		if (erasec) {
			...
			g.drawString("SeSi", pw/3 + 5*dax + 4, dpy + 20);
			g.drawString(Integer.toString(10), dpx + dax, dpy + phG - day/2);
			g.drawString(Integer.toString(ntimes-10), dpx + pw - dax - dax/2, dpy + phG - day/2);
				
			//if (startmovie == false) {
				
				g.drawString(Integer.toString(ermin), dpx + dax/2, dpy + phG - day);
				g.drawString(Integer.toString(ermax), dpx + dax/3 - 3, dpy + day - 2);
			...
			/*}
				...
				g.drawString(Integer.toString(ermin), dpx + da/2, dpy + phm - da);
				g.drawString(Integer.toString(ermax), dpx + da/3 - 3, dpy + da - 2);
				...
				for (int t = 10; t < ntimes - 10; t++) {
					...
					ayp2	= dpy + phm - da;	//y axes point 2
					ayp3	= dpy + phm - da;	//y axes point 3
					kk1 = (phm - 2*da)*(erased[nii][njj][t]	    - ermin)/(ermax - ermin);
					kk2 = (phm - 2*da)*(erased[nii][njj][t + 1] - ermin)/(ermax - ermin);
		...
		if (spaveragec) {
			...
			g.setColor(Color.red);
			g.drawString("SpAvSi", pw/3 + 6*dax + 4, dpy + 20);
			g.drawString(Integer.toString(10), dpx + dax, dpy + phG - day/2);
			g.drawString(Integer.toString(ntimes-10), dpx + pw - dax - dax/2, dpy + phG - day/2);
				
			//if (startmovie == false) {
				
				g.drawString(Integer.toString(spamin), dpx + dax/2, dpy + phG - day);
				g.drawString(Integer.toString(spamax), dpx + dax/3 - 3, dpy + day - 2);
			...
			/*}
				...
				g.drawString(Integer.toString(spamin), dpx + da/2, dpy + phm - da);
				g.drawString(Integer.toString(spamax), dpx + da/3 - 3, dpy + da - 2);
		...
		if (thresholdc) {
			...
			g.drawString(Integer.toString(ur), dpx + dax/2, dpy + phG/2);
		...
		if (apdDistc) {
			...
			g.drawString("DI (ms)", dpx + pw - dax, ph + dpy - day/3);
			...
			g.drawString(Integer.toString(minapd), dpx + dax/2, dpy + phG - day);
			g.drawString(Integer.toString(maxapd), dpx + dax/3 - 3, dpy + day - 2);
			
			for (int n = 1; n < ntr[nii][njj]; n++) {
			
				
				System.out.println("di" + "[" + nii + "]" + "[" + njj + "]" + "[" + n + "]: " + di[nii][njj][n]);
				System.out.println("apd" + "[" + nii + "]" + "[" + njj + "]" + "[" + n + "]: " + apd[nii][njj][n]);
		...
		if (apdDiMeanc) {
			...
			if (alternancec) {
				...
				g.setColor(Color.blue);
				pcx1 = dpx + dax + mdiAe[nii][njj]*(pw - 2*dax)/(maxdi - mindi);
				pcy1 = dpy + phG - day - (phG - 2*day)*(mapdAe[nii][njj] - minapd)/(maxapd - minapd);
	...
	public void run(){
		...
		while (true) {
			...
			*/
			...
			//source.newPixels(dsx + 2, dsy + 2, ss, ss);
		}
	}//close run
	...
	public void  actionPerformed( ActionEvent ae ){
		...
		if (ae.getSource() == spaaverage) {
			...
			System.out.println("\nSpace average....");
			spaceAverage(u, nf, ntimes, nii, njj, spaceaveraged);//Call method to performe the space average
		...
		//Perform B:-> APD - DI thresholds evaluation
		...
		if (ae.getSource() == apdDiMean) {
			...
			if (alternancec) {
				meanApdDiA(nf, ntr, di, apd, mdiAo, mapdAo, mdiAe, mapdAe);
			}
			else {
	...
	public void itemStateChanged(ItemEvent ie ){
		...
		if (alternance.getState() == true)  alternancec = true;
		else 								alternancec = false;
	...
	public short[][][] readArray( String namefilel ) { 
		...
		try{
			...
			System.out.println("video" + "[" + 100 + "]" + "[" + nii + "]" + "[" + njj + "]: " + video[100][50][50]);
			System.out.println("video" + "[" + 110 + "]" + "[" + nii + "]" + "[" + njj + "]: " + video[110][50][50]);
	...
	public short[][][] convertArray(short[][][] video, int nf, int ntimes, 
		...
		System.out.println("End of converting and copying");
	...
	public static void minMax( short[][][] u, int nf, int ntimes, 
		...
		System.out.println("Max in " + "[" + nii + "]" + "[" + njj + "]: " + max[nii][njj]);
		System.out.println("min in " + "[" + nii + "]" + "[" + njj + "]: " + min[nii][njj]);
	...
	public static void shiftSignal( short[][][] u, int nf, int ntimes, int ifreq, 
		...
		System.out.println("u" + "[" + nii + "]" + "[" + njj + "]" + "[" + 100 + "]: " + shifted[nii][njj][100]);
		System.out.println("u" + "[" + nii + "]" + "[" + njj + "]" + "[" + 110 + "]: " + shifted[nii][njj][110]);
	...
	public static void spaceAverage( short[][][] u, int nf, int ntimes, 
		...
		System.out.println("u" + "[" + nii + "]" + "[" + njj + "]" + "[" + 100 + "]: " + spaceaveraged[nii][njj][100]);
		System.out.println("u" + "[" + nii + "]" + "[" + njj + "]" + "[" + 110 + "]: " + spaceaveraged[nii][njj][110]);
		System.out.println("End of space average");
	}//close spaceAverage
	...
	public static void normaSignalGN( short[][][] signal, int nf, int ntimes, 
		...
		System.out.println("u" + "[" + nii + "]" + "[" + njj + "]" + "[" + 100 + "]: " + signal[nii][njj][100]);
		System.out.println("u" + "[" + nii + "]" + "[" + njj + "]" + "[" + 110 + "]: " + signal[nii][njj][110]);
		System.out.println("End of normalization");
	...
	public static void apdDI( short[][][] u, int nf, int ntimes,
		...
		System.out.println("ntr" + "[" + nii + "]" + "[" + njj + "]: " + ntr[nii][njj]);
		System.out.println("nb" + "[" + nii + "]" + "[" + njj + "]: " + nb[nii][njj]);
		System.out.println("apd" + "[" + nii + "]" + "[" + njj + "]: " + apd[nii][njj][ntr[nii][njj]]);
		System.out.println("di" + "[" + nii + "]" + "[" + njj + "]: " + di[nii][njj][ntr[nii][njj]]);
		
		System.out.println("End od APD - DI");
	...
	public static void meanApdDi( int nf, 
		...
		for (int i = 0; i < nf; i++){
			for (int j = 0; j < nf; j++){
				...
				for (int k = 1; k < ntr[i][j] - 1; k++){
					...
					sumdi = sumdi + 2*di[i][j][k];
					sumapd = sumapd + 2*apd[i][j][k];
		...
		System.out.println("End of mean");
